...
export const colorValid = color => typeof color === 'string' && color.length > 0 && color.charAt(0) === '#' ? true : false
export const projectValid = project => Array.isArray(project) && project.length === 2 && project[1].type === 'project' ? true : false
